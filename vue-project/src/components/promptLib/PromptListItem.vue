...
import { ref } from "vue";
import { PromptObject } from "./PromptListArea.vue";
        ...
        <Flex vertical gap="middle">
            <Flex gap="large">
                ...
                <Flex v-visibility="hover" :gap="2">
                    <Button size="small" shape="circle" @click="addToWorkspace"><PlayCircleOutlined /></Button>
                    <Button size="small" shape="circle"><CopyOutlined /></Button>
                </Flex>
            </Flex>
